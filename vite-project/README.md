...
If I'm going to do the step up the best thing for me to do is seperate the components, home then quiz file then the results which needs to be saved could be a new file. The best tool I know for this is React as they deal with separate components. Imma try and usereducer
